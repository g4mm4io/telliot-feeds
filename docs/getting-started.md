...
- [Python 3.9](https://www.python.org/downloads/release/python-3915/) is required to install and use `telliot-feeds`, refer [Install Python 3.9 using pyenv](#install-python-39-using-pyenv). Alternatively, you can use our [docker](https://docs.docker.com/get-started/) release. If using Docker, please follow the [Docker setup instructions](#optional-docker-setup).

## Install Python 3.9 using pyenv

pyenv is a Python version manager that lets you easily switch between multiple versions of Python. With pyenv you don't need to uninstall the Python version you're using, it avoids causing problems with applications that rely on your current version. You can install pyenv following the [pyenv documentation](https://github.com/pyenv/pyenv).
