...
def test_build_feed_from_input(capsys):
    ...
    num_choice = 9  # NumericApiResponse is the 9th option
...
def test_cmd_tip():
    ...
    runner = CliRunner()
    fetch = "0.00001"
    result = runner.invoke(cli_main, ["--test_config", "tip", "--amount-usd", fetch])

    expected = "Error: No such option: --amount-usd Did you mean --amount-fetch?"
